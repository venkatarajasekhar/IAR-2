...
Iar_EvolutionController::Iar_EvolutionController( RobotWorldModel *__wm ) : Controller ( __wm )
{
...
Iar_EvolutionController::~Iar_EvolutionController()
{
	// nothing to do.
}

void Iar_EvolutionController::reset()
{
	// nothing to do.
}

void Iar_EvolutionController::step()
{
...
void Iar_EvolutionController::monitorSensoryInformation()
{
